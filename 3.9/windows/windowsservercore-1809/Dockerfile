...
RUN $url = 'https://downloads.python.org/pypy/pypy3.9-v7.3.13-win64.zip'; \
	Write-Host ('Downloading {0} ...' -f $url); \
	Invoke-WebRequest -Uri $url -OutFile 'pypy.zip'; \
	\
	$sha256 = '85745a2055c4a8cefac9b6d3f7f305b1edaaf62468c8f640b4511d9dd21d091c'; \
	Write-Host ('Verifying sha256 ({0}) ...' -f $sha256); \
	...
	\
	Write-Host 'Renaming ...'; \
	Rename-Item -Path C:\pypy3.9-v7.3.13-win64 -NewName C:\pypy; \
	\
